...
var accorden = function accorden(triggerSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (accorden);
...
var drop = function drop() {
  ...
  function highLighter(input) {
    input.closest('.file_upload').style.backgroundColor = '#cebfa8';
    input.closest('.file_upload').style.border = '1px solid red';
  }

  function unhighLighter(input) {
    input.closest('.file_upload').style.backgroundColor = 'inherit';
  ...
  inputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var name = arr[0].slice(0, 5) + dots + arr[1];
...
var modal = function modal() {
  ...
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true); // showModalByTime('.popup-consultation', 3000);
};
...
var showMoreStyles = function showMoreStyles(triggerSelector, wrapper) {
  ...
  function createCard(response) {
    response.forEach(function (_ref) {
      ...
      styleCard.classList.add('animated', 'fadeInDown', 'col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1');
      styleCard.innerHTML = "<div class=\"styles-block\">\n                                    <img src=".concat(src, " alt=\"style\">\n                                    <h4>").concat(title, "</h4>\n                                    <a href=\"").concat(link, "\">\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a>\n                                 </div>");
...
var showPicture = function showPicture(blocksSelector) {
...
var sliders = function sliders(slideSelector, dir, prev, next) {
  var slideIndex = 1;
